      ...
      <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <button
            ...
            className="bg-yellow-400 text-[#0B1C3E] px-6 py-3 rounded-md font-semibold hover:bg-yellow-500"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="text-xl philosopher-regular mb-4 bg-gradient-to-r from-[#d4af37] via-[#f8e45f] to-[#d4af37] bg-clip-text text-transparent">
                    {feature.title}
                  </h3>
